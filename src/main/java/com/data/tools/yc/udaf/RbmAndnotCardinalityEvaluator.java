...
public class RbmAndnotCardinalityEvaluator extends GenericUDAFEvaluator {
    ...
    public void iterate(AggregationBuffer aggregationBuffer, Object[] objects) throws HiveException {
        ...
        try {
            ((RbmAggregationBuffer) aggregationBuffer).andNot(RbmAggregationBuffer.fromBase64Str(input));
        } catch (IOException e) {
    ...
    public void merge(AggregationBuffer aggregationBuffer, Object o) throws HiveException {
        ...
        try {
            ((RbmAggregationBuffer) aggregationBuffer).andNot(RbmAggregationBuffer.fromBytes(input));
        } catch (IOException e) {
            throw new HiveException(input + "can not deserialize to bitmap");
        }
