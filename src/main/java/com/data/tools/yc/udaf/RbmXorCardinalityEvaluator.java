...
public class RbmXorCardinalityEvaluator extends GenericUDAFEvaluator {
    ...
    public void iterate(AggregationBuffer aggregationBuffer, Object[] objects) throws HiveException {
        ...
        try {
            ((RbmAggregationBuffer) aggregationBuffer).xor(RbmAggregationBuffer.fromBase64Str(input));
        } catch (IOException e) {
    ...
    public void merge(AggregationBuffer aggregationBuffer, Object o) throws HiveException {
        ...
        try {
            ((RbmAggregationBuffer) aggregationBuffer).xor(RbmAggregationBuffer.fromBytes(input));
        } catch (IOException e) {
            throw new HiveException(input + "can not deserialize to bitmap");
        }
