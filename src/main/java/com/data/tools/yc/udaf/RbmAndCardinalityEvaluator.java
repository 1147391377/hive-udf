...
public class RbmAndCardinalityEvaluator extends GenericUDAFEvaluator {
    ...
    public void iterate(AggregationBuffer aggregationBuffer, Object[] objects) throws HiveException {
        ...
        try {
            ((RbmAggregationBuffer) aggregationBuffer).and(RbmAggregationBuffer.fromBase64Str(input));
        } catch (IOException e) {
    ...
    public void merge(AggregationBuffer aggregationBuffer, Object o) throws HiveException {
        ...
        try {
            ((RbmAggregationBuffer) aggregationBuffer).and(RbmAggregationBuffer.fromBytes(input));
        } catch (IOException e) {
            throw new HiveException(input + "can not deserialize to bitmap");
        }
